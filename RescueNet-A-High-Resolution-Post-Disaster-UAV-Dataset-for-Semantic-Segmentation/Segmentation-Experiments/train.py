...
def get_parser():
    ...
    parser.add_argument('--config', type=str, default='config/rescuenet-segmenter.yaml', help='config file')
    parser.add_argument('opts', help='see config/rescuenet-segmenter.yaml', default=None, nargs=argparse.REMAINDER)
...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    params_list = [{'params': model.parameters(), 'lr': args.base_lr}]
    args.index_split = 5
